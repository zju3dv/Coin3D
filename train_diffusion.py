...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("-b", "--base", type=str, default='configs/coin3d_train.yaml',)
    ...
    parser.add_argument("--finetune_from", type=str, default="ckpt/syncdreamer-pretrain.ckpt", help="path to checkpoint to load model state from" )
